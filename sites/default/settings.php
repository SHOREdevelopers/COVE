...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_rc_distro_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_rc_distro_dd.inc';
}
// </DDSETTINGS>
if (isset($_SERVER['PANTHEON_ENVIRONMENT']) && php_sapi_name() != 'cli') {
  ...
  if ($_ENV['PANTHEON_ENVIRONMENT'] === 'live') {
    ...
    $primary_domain = 'editions.covecollective.org';
  }
  else {
