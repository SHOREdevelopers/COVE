    ...
    */
    ...
    AnnotatorViewer.prototype.textareaEditor = function(annotator_textArea,item) {
      ...
      AnnotatorViewer.prototype.tinymceActivation = function(selector) {
            tinymce.init({
              selector: selector,
              plugins: "media image link paste",
              menubar: false,
              statusbar: false,             
    ...
    AnnotatorViewer.prototype.mascaraAnnotation = function(annotation) {  
      ...
      annotation_layer += '<div class="anotador_text">'+  textAnnotation  + '</div></div><div class="annotator-marginviewer-quote">'+ annotation.quote + '</div><div class="annotator-marginviewer-footer"><span class="'+class_label+'">' + annotation.user + '</span>'+shared_annotation+delete_icon+'</div>';
